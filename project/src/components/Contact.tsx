            ...
            <div className="flex flex-col">
                ...
                <div className="flex space-x-3">
                    <Link href="https://github.com/KBluelvl">
                        <Image src="/image/github.jpg" width={45} height={45} className="border rounded-full mb-5"  alt="GitHub logo" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/florian-essomba-804b1b216/">
                        <Image src="/image/linkedin.jpg" width={45} height={45} className="border rounded-full mb-5"  alt="Linkedin logo" />
                    </Link>
                </div>
            </div>
            <div className="flex flex-col">
