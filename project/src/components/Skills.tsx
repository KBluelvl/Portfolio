    ...
    return (<>
        <h1 className="text-2xl sm:text-1xl font-semibold mt-20 mb-20 text-center">Skills</h1>
          <div className="grid grid-cols-5 gap-1 text-xs">
            <div className="hover:bg-hoverIcon transition ease-out hover:scale-110">
            ...
            <div className="hover:bg-hoverIcon transition ease-out hover:scale-110"> {/* SVG because it change color light/dark mode */}
